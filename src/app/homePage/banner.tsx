      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex flex-wrap gap-3.5 flex-1 min-w-0">
          {stats.map(({ label, value, icon: Icon, cardClass, iconClass }) => (
            <div
              key={label}
              className={`flex items-center gap-3 px-[18px] py-3.5 rounded-lg border border-[var(--border-subtle)] min-w-0 flex-1 max-w-[210px] transition-[transform,box-shadow] duration-150 hover:-translate-y-px ${cardClass}`}
            >
              <div
        ...
        <div className="flex items-center gap-3.5 px-[18px] py-3 rounded-lg border border-[var(--border-subtle)] bg-bg-elevated shrink-0 w-[360px]">
          <div
